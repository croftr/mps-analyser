    ...
    <section id="mpDetailsPage" className="flex flex-col items-center justify-between">
      ...
      <div className="header flex flex-col items-start justify-center p-4 rounded-md dark:bg-gray-800 bg-gray-100 dark:text-white gap-2">
        ...
        <div className="flex gap-2">
          <svg style={{ flexShrink: 0 }} className="standalone-svg" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="flex gap-2">
          <svg className="standalone-svg" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
