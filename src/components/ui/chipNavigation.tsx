...
const navItems = [    
    ...
    { label: "Donated to and recieved contract from", icon: Eye, href: "insights?type=org&donatedto=Conservative&awardedby=Any%20Party&limit=200&minTotalDonationValue=100&minContractCount=1&orgtype=Any", color: "bg-green-100 hover:bg-green-200" }, 
